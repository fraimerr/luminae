					...
					<div className="space-y-4">
						...
						<div className="space-y-2">
							...
							<div className="grid grid-cols-3 gap-2">
								<Button variant="outline" size="sm" className="w-full">Solid</Button>
								<Button variant="outline" size="sm" className="w-full">Gradient</Button>
								<Button variant="outline" size="sm" className="w-full">Pattern</Button>
							</div>
						</div>
					</div>
				</CardContent>
					...
					<div className="space-y-4">
						<div className="space-y-2">
							...
							<div className="grid grid-cols-2 gap-2">
								<Button variant="outline" size="sm" className="w-full">Default</Button>
						...
						<div className="space-y-2">
							...
							<div className="grid grid-cols-2 gap-2">
								<Button variant="outline" size="sm" className="w-full font-sans">Sans</Button>
								<Button variant="outline" size="sm" className="w-full font-serif">Serif</Button>
							</div>
						</div>
					</div>
				</CardContent>
